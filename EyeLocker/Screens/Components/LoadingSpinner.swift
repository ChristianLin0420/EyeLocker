...
struct Spinner: View {
    ...
    @State var startConnect = false
    var connectStateLabel: String
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                ...
                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: darkBlue)

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: darkPink)

            }.frame(width: frameSize, height: frameSize)
            
            Text(connectStateLabel)
